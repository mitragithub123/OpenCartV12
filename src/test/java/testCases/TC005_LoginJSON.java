...
public class TC005_LoginJSON extends BaseTest{
	/*Valid data
	...
	@Test(dataProvider = "loginDataJson", dataProviderClass = DataProviders.class, groups="Datadriven")
	public void verifyLoginDDT(HashMap<String, String> input) throws InterruptedException {
		try {
